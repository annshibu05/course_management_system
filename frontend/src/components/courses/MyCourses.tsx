...
export const MyCourses: React.FC = () => {
  ...
  //         Authorization: `Bearer ${localStorage.getItem('token')}`,
  //       },
  //       body: certificateData, // FormData includes file and metadata
  //     });
  ...
  //       setCourses((prev) =>
  //         prev.map((course) =>
  //           course._id === courseId ? { ...course, certificateLink: updatedCertificate.fileUrl } : course
  //         )
  //       );
  ...
  //         }}
  //         onSubmit={(data: any) => {
  //           handleEditCourse(selectedCourse._id, data); // Ensure correct ID is passed
  //         }}
  //       />
  //       )}
